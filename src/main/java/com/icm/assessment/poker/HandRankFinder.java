...
import com.icm.assessment.poker.utils.CardSort;
import com.icm.assessment.poker.utils.SuitSort;
import java.util.Arrays;

/* To determine strength of the Poker hand.
Credit to http://www.mathcs.emory.edu/~cheung/Courses/170/Syllabus/10/pokerValue.html */
public class HandRankFinder {
    ...
    public static boolean isStraight(Card[] cards) {
        ...
        if (cards[4].getRank() == 14 &&
                cards[0].getRank() == 2 && cards[1].getRank() == 3 &&
